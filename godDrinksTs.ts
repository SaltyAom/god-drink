...
export default class GodDrinks {
    ...
    constructor() {
        ...
        if (me instanceof SineWave)
            ...
            // TANGENTS
            you.can(Actions.SIT, me.tangent(you.x))
        ...
        me.blind = true
        // So dizzy, so dizzy
        me.feelings.add(FEELINGS.DIZZY)
        ...
        if (me.feelings.has(FEELINGS.VIBRATIONS))
            ...
            // COMPLETION
            me.feelings.add(FEELINGS.COMPLETE)
        ...
        world.execution.run()
        // EIN
        world.announce(1, LANGUAGES.GERMAN) // ein; German
        // DOS
        world.announce(2, LANGUAGES.SPANISH) // dos; Español
        // TROIS
        world.announce(3, LANGUAGES.FRENCH) // trois; French
        // NE
        world.announce(4, LANGUAGES.KOREAN) // 넷; Korean
        // FEM
        world.announce(5, LANGUAGES.SWEDISH) // fem; Swedish
        // LIU
        world.announce(6, LANGUAGES.CHINESE) // 六; Chinese
        // EXECUTION
        world.execution.run()
        ...
        // LO-O-OVE
        me.find(Math.Algebraic.Expression, FEELINGS.LOVE)
        // Though you are free
