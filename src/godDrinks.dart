/**
 * The program GodDrinksDart implements an application that
...
import 'package:world/simulation.dart';
...
class GodDrinks {
  ...
  GodDrinks() {
    ...
    // INITIALIZATION
    final me = Lovable(Me);
    final you = Lovable(You);

    // Set up our new world
    final world = World(me, you);
    // And let's begin the
    // SIMULATION
    world.start(Simuation);
    ...
    // Oh, we can travel
    world.time = DateTime.parse("617 AD");
    // To A.D., to B.C.
    world.time = DateTime.parse("3691 BC");
    ...
    // SIMULATIONS
    if (me.simulations.availables.length >= you.simulations.needs.length)
      // Then I can
    ...
    try {
      me.opinions[world.has(you)] = false;
    }
    // You have made some
    catch (e) {
      // ILLEGAL ARGUMENTS
